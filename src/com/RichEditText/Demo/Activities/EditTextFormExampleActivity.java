...
import com.RichEditText.Demo.Widgets.LayoutListItem;
import com.RichEditText.Demo.Widgets.ListItem;
import com.RichEditText.Demo.Widgets.SimpleListItem;
...
public class EditTextFormExampleActivity extends ListActivity implements OnItemClickListener{
	...
	public void onCreate(Bundle savedInstanceState){
		...
		ArrayList<String> mListTitles = new ArrayList<String>(); 
		
		for(ListItem mItem : mItems) {
			mListTitles.add(mItem.getListTitle());
		}
